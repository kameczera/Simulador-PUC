...
public class Processo {
    ...
    public Processo(String nomeArquivo, int id)
    {
        try {
            ...
            while (linha != null) {
                // Vai separar a linha em 2 partes, uma sendo a instrucao e outra sendo os componentes.
                // Ex: addi r1,r1,r1 -> partes[] = {addi}, registradores[] = {r1,r1,r1}. 
                // Nao necessariamente todas instrucoes vao utilizar 3 componentes que serao registradores
                ...
                int idInstrucao = -1;
                Nodo n = new Nodo();
                // Como dito anteriormente, cada instrucao tem suas peculiaridade. Ter atencao no switch
                switch(partes[0]){
                    case "add":
    ...
    // avancarInstrucao é um metodo utilizado apenas no BMT para ajudar na simulacao dos DELAYS, enquanto uma thread está executando, a outra vai eliminando o
    // tempo de DELAY e de I/O ou rede.
    public void avancarInstrucao(){
        Nodo p = instrucoes.get(instrucaoAtual);
        if(p.getInstrucao()[0] == -1) instrucaoAtual++;
    }
